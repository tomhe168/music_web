...
var g_u_play_icon = `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 16 16" class="u_playPauseIcon">
...
var g_u_pause_icon = `<svg class="u_playPauseIcon" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 16 16" >
<circle cx="8" cy="8" r="8" fill="#e99d42" />
<rect x="5" y="4" width="2" height="8" rx="1" ry="1" fill="white" />
<rect x="9" y="4" width="2" height="8" rx="1" ry="1" fill="white" />
</svg>`;
